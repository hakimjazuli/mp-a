...
export class MpA extends HTMLAnchorElement {
	...
	static routerErrorDocString =
		'<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>mp-a: routing error</title></head><body>mp-a:side routing error page go to:<a not-mp-a href="/">home</a></body></html>';
	/**
